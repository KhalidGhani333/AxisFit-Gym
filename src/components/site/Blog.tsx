    ...
    <section id="blog" className="bg-forge-bg py-28 md:py-36">
      <div className="container mx-auto max-w-7xl px-6">
        <div className="reveal-left text-center mb-20">
          ...
          <h2 className="watermark-text" style={{ fontSize: "clamp(40px, 10vw, 100px)" }}>From the Blog</h2>
        </div>
          ...
          {posts.map((p, i) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <h3 className="mt-5 font-display text-lg md:text-xl text-white group-hover:text-forge-red transition-colors duration-300 leading-tight">
                  {p.title}
                </h3>
