    ...
    <footer className="bg-[#050505] pt-20 pb-8 border-t border-white/[0.06]">
      <div className="container mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <Link to="/" className="flex items-end gap-1 mb-5">
              <span className="font-display text-3xl text-white leading-none">AXISFIT</span>
          ...
          <div>
            <h4 className="font-display text-xs text-white mb-5 tracking-wider">Training</h4>
            <ul className="space-y-3 text-xs text-[#aaa]">
          ...
          <div>
            <h4 className="font-display text-xs text-white mb-5 tracking-wider">Company</h4>
            <ul className="space-y-3 text-xs text-[#aaa]">
          ...
          <div>
            <h4 className="font-display text-xs text-white mb-5 tracking-wider">Stay in Touch</h4>
            <p className="text-xs text-[#aaa] mb-4">Get weekly training tips and exclusive offers.</p>
            <form className="flex flex-col gap-3" onSubmit={(e) => e.preventDefault()}>
              <input
                type="email"
                placeholder="your@email.co.uk"
                className="bg-transparent border border-white/30 px-4 py-3 text-xs text-white placeholder:text-white/40 focus:border-forge-red outline-none transition-colors"
              />
        ...
        <div className="mt-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-[12px] text-[#666]">
          <p>
            Powered By <a href="https://axistechgroup.com/" target="_blank" rel="noopener noreferrer" className="text-forge-red hover:underline">AxisTechGroup</a>
